...
public class q9 extends AppCompatActivity {
    ...
    public void addListenerOnButton() {
        ...
        one.setOnClickListener(new View.OnClickListener() {
                                     @Override
                                     public void onClick(View v) {
                                         Toast.makeText(getApplicationContext(), "Congratulations!You have been promoted to class X :D", Toast.LENGTH_SHORT).show();

                                         Intent intent=new Intent(context,q10.class);//q3 is in fact q2
