    ...
    public void addListenerOnButton() {
        ...
        four.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), "Congratulations!You have been promoted to class III :D", Toast.LENGTH_SHORT).show();

                Intent intent=new Intent(context,q2.class);//here q2 refers to q3
