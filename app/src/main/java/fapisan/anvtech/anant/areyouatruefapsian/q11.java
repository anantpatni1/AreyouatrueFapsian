...
public class q11 extends AppCompatActivity {
    ...
    public void addListenerOnButton() {
        ...
        three.setOnClickListener(new View.OnClickListener() {
                                     @Override
                                     public void onClick(View v) {
                                         Toast.makeText(getApplicationContext(), "Congratulations!You have been promoted to class XII :D", Toast.LENGTH_SHORT).show();

                                         Intent intent=new Intent(context,q12.class);//q3 is in fact q2
