    ...
    public void addListenerOnButton() {
        ...
        four.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                 Toast.makeText(getApplicationContext(), "Congratulations!You have been promoted to class XI :D", Toast.LENGTH_SHORT).show();

                                         Intent intent=new Intent(context,q11.class);//q3 is in fact q2
