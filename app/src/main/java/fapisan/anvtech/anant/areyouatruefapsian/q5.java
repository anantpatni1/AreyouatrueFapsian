...
public class q5 extends AppCompatActivity {
    ...
    public void addListenerOnButton() {
        ...
        one.setOnClickListener(new View.OnClickListener() {
                                     @Override
                                     public void onClick(View v) {
                                            Toast.makeText(getApplicationContext(), "Congratulations!You have been promoted to class VI :D", Toast.LENGTH_SHORT).show();

                                         Intent intent=new Intent(context,q6.class);//q3 is in fact q2
