...
public class q6 extends AppCompatActivity {
    ...
    public void addListenerOnButton() {
        ...
        two.setOnClickListener(new View.OnClickListener() {
                                            @Override
                                            public void onClick(View v) {
                                             Toast.makeText(getApplicationContext(), "Congratulations!You have been promoted to class VII :D", Toast.LENGTH_SHORT).show();

                                         Intent intent=new Intent(context,q7.class);
